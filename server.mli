...
(** [get_notifications u] returns a list of notifications user [u] has 
    from individual conversations and group chats. *)
val get_notifications : string -> string list  
...
(** [add_users_to_gc gc u] adds list of users [u] to group chat [gc] *)
val add_users_to_gc : string -> string list -> unit 
